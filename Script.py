class script(object):
    START_TXT = """ MOVIE BOT {} 💖
I'm Powerful Auto-Filter Bot You Can Use Me As A Auto-Movie-filter in Your Group

Its Easy To Use Me; Just Add Me To Your Group As Admin, 
Thats All, i will Provide Movies There in File Format...🤓🤪
...
- Filter is the feature were users can set automated replies for a particular keyword and movie filter bot will respond whenever a keyword is found the message

<b>NOTE:</b>
1. Movie Filter Bot should have admin privillage.
...
2. Movie Filter Bot supports buttons with any telegram media type.
