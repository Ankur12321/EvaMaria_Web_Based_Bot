    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('Check PM, I have sent files in personal message', show_alert=True)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 𝚄𝚙𝚍𝚊𝚝𝚎𝚜', url='https://t.me/Bamel_Backup')
        ], [
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>📁 Found</b> {total_results} <b>Files For</b> {search} \n\n<i>⚡ Uploaded By</i> @Bamel_Shab \n\n[How to Search 🔍 And Download⬇️ : <a href=https://t.me/Bamel_Backup/8>👉 Click Here 👈 ] </a> ✔️"
